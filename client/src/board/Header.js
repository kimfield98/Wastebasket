...
function Header() {
    return (
        <div className='headerstyles'>
            <div><Link className='headercomponent' to='/'>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-envelope-open-heart" viewBox="0 0 16 16">
            ...
            <nav>
                <div>
                    <div><Link className='headercomponent' to='/Signin'>
