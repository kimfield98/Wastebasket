...
| 설명 | 세계 재난 재해 구독 알림 서비스 웹 사이트 | 알고리즘 스터디 그룹 활동 관리 웹 사이트 | 게시판 만들기
...
| 기술 | **Next.js, TypeScript, Recoil** | **Django, Python, JavaScript** | React, Express
